...
struct trackoptions track_tablature = {
	-1,             /* dev open */
	 0,
	NULL,           /* char *port */
	0,              /* int motorx */
	...
	TRACK_SPEED,    /* speed */
	0,
	0,              /* auto tracking active */
	0,
	0,
	0,
	0,
	0,              /* flag for minmax values stored for pwc based camera */
	10,             /* step angle in degrees X-axis that camera moves during auto tracking */
	10,             /* step angle in degrees Y-axis that camera moves during auto tracking */
	10,              /* number of frames to disable motion detection after camera moving */
	0,
	0
};
