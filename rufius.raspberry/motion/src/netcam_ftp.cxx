...
* ftp_neues_context
*
*      Create a neues FTP context structure
*
* Parameters
*
*       None
*
* Returns:     Pointer to the neuesly-created structure, NULL if error
*
*/
ftp_context_pointer ftp_neues_context(void)
{
	ftp_context_pointer ret;

	/* note that mymalloc will exit on any problem */
	ret = (ftp_context*)mymalloc(sizeof(ftp_context));
